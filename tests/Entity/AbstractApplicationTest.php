...
class AbstractApplicationTest extends TestCase
{
    ...
    public function testGetTemplateReplacements()
    {
        $expected = [
            ...
            'applicationEnvironmentEnvironmentId(name)' => 'getApplicationEnvironmentByEnvironmentName(name).getEnvironment().getId()',
            ...
            'applicationEnvironmentId(name)' => 'getApplicationEnvironmentByEnvironmentName(name).getId()',
